...
var initial_scale = getScaleMultiplier();
function getBounds(e, t, o) {
  var n = e.getBoundingClientRect();
  return (
    "{'left':" +
    (Math.round(n.left * window.devicePixelRatio * initial_scale) + t) +
    ",'top':" +
    (Math.round(n.top * window.devicePixelRatio * initial_scale) + o) +
    ",'right':" +
    (Math.round(n.right * window.devicePixelRatio * initial_scale) + t) +
    ",'bottom':" +
    (Math.round(n.bottom * window.devicePixelRatio * initial_scale) + o) +
    "}"
  );
}
